...
(ert-deftest 0xc--infer-base-test ()
  (let ((user-0xc-clamp-ten 0xc-clamp-ten)
    ...
    (should (equal (0xc--infer-base "'b101010") 2))
    (should (equal (0xc--infer-base "'o123456") 8))
    (should (equal (0xc--infer-base "'d246810") 10))
    (should (equal (0xc--infer-base "'h101010") 16))
...
(ert-deftest 0xc--reverse-string-test ()
  ...
  (should (equal (0xc--reverse-string "'h10ff") "ff01h'"))
...
(ert-deftest 0xc--strip-base-hint-test ()
  ...
  (should (equal (0xc--strip-base-hint "'h10ff") "10ff"))
  (should (equal (0xc--strip-base-hint "0d246810") "246810"))
  (should (equal (0xc--strip-base-hint "'d246810") "246810"))
  (should (equal (0xc--strip-base-hint "0x") ""))
  (should (equal (0xc--strip-base-hint "0b") ""))
...
(ert-deftest 0xc-convert-test ()
  ...
  (should (equal (0xc-convert 10 "'hff" t) "255"))
  (should (equal (0xc-convert 10 "0b1010" t) "10"))
  (should (equal (0xc-convert 10 "'b1010" t) "10"))
